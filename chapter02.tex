...
行内公式可以用\texinline{$$}来包围，比如\texinline{$(a+b)^2=a^2+2ab+b^2$}，效果 \( (a+b)^2 = a^2 + 2ab + b^2
...
\subsection{常用的数学环境}
\begin{itemize}[label=\twemoji{elephant}, nosep]
...
\subsection{常用的数学命令}
\begin{itemize}
	\item 分式 \inlinedemo{\frac{b}{a}}
	\item 根号 \inlinedemo{\sqrt[4]{a^3}}
